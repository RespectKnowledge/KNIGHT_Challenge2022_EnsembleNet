...
filet=pd.read_csv('/home/imranr/knights/train_normalized_feat_corrected.csv')
data='/home/imranr/knights/data'

filev=pd.read_csv('/home/imranr/knights/test_normalized_feat.csv')
...
model=FuseModelDefault(0.5,5,0.5)
